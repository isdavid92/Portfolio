...
const Portfolio = () => {
    ...
    return (
        <div className={style.Portfolio} id="portfolio">
            <a href="https://drive.google.com/file/d/1o1brj-M8hFUGzo0jfND8iEj2OF2VOghM/view?usp=sharing" className={style.a} target="blank">
            ...
            <div className={style.info}>
                <div className={style.infoL}>
                    <div className={style.divInfoL}>
                        <a href="mailto:isdavid92@hotmail.com" className={style.aL}>
                    ...
                    <div className={style.divInfoL}>
                        <a href="https://api.whatsapp.com/send/?phone=573015885116&text&type=phone_number&app_absent=0" className={style.aL} target="blank">
                    ...
                    <div className={style.divInfoL}>
                        <a href="https://www.linkedin.com/in/israel-david-aguilar-cepeda-25175126a/" className={style.aL} target="blank">
                    ...
                    <div className={style.divInfoL}>
                        <a href="https://github.com/isdavid92" className={style.aL} target="blank">
                    ...
                    <div className={style.divInfoL}>
                        <a href="https://www.google.com/maps/place/Medell%C3%ADn,+Antioquia/@6.244197,-75.6636136,12z/data=!3m1!4b1!4m6!3m5!1s0x8e4428dfb80fad05:0x42137cfcc7b53b56!8m2!3d6.2476376!4d-75.5658153!16zL20vMDF4XzZz?hl=es&entry=ttu" className={style.aL} target="blank">
